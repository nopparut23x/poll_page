...
<body>
    ...
    <br>
    <a class="a-out" onclick="return confirm('คุณต้องการคืนค่าผลการทำเเบบสำรวจหรือไม่')" href="?reset=<?php echo $_GET['id'] ?>">คืนค่าผลการทำเเบบสำรวจ</a>
<br><br>
    <div class="d-fixed">
...
<?php foreach($log_ans as $row_ans){ 
    ...
    ?>
<p><b>คำตอบ </b><?php echo $row_ans['ans_text'] ?> จำนวนการตอบ <?php echo $sum['sum_count'] ?> คน สรุปเป็นเปอเซ็น <?php  echo $total_cut."%"?> </p>
<?php } ?>
<br>
